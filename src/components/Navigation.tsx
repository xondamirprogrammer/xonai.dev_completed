...
export default function Navigation({ setCurrentPage, currentPage }: NavigationProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div style={{ paddingLeft: '2rem', paddingRight: '2rem' }} className="py-4 flex items-center justify-between max-w-none">
        <div 
      ...
      {isOpen && (
        <div className="md:hidden bg-background/95 backdrop-blur-md border-t border-border">
          <div style={{ paddingLeft: '2rem', paddingRight: '2rem' }} className="py-4 space-y-4">
            {isSmartWebsitesPage ? (
              <>
