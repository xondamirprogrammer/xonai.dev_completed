  ...
  'home': {
    ...
    services: {
      'smart-websites': {
        ...
        description: "Professional websites with integrated AI automation for e-commerce, healthcare, and education. Superior to template-based solutions. Includes intelligent lead capture, automated customer communication, and complete business integration with 24/7 AI support."
      },
      'ai-agents': {
        title: "E-commerce AI Agents & Complete Business Automation (Beyond Basic Chatbots)", 
        description: "Comprehensive AI automation systems for e-commerce customer support, sales optimization, and complete business operations. Unlike basic e-commerce chatbots, Gliglish conversation AI, or Mizou school tools, handles everything: customer support, order tracking, product recommendations, enrollment, scheduling, and analytics with 25-40% sales increase."
      },
      automation: {
        title: "Medical Practice AI Automation (Beyond Basic Booking)",
        description: "Complete medical practice automation beyond basic appointment booking like SimplyBook or TIMIFY. Includes AI patient communication, intelligent scheduling, automated follow-ups, and comprehensive practice optimization with 30-50% efficiency improvement."
      },
      customTools: {
        title: "Language Center AI Revolution (Beyond Generic School Tools)",
        description: "Specialized language center automation beyond what generic school chatbots like Mizou or Tawk.to offer. Complete enrollment automation, intelligent class management, multilingual parent communication, and student progress tracking with 50-70% admin reduction."
      }
    },
    altTexts: {
      hero: "Complete AI automation dashboard demonstrating superior business workflow optimization for e-commerce stores, language centers and medical clinics, showcasing advanced capabilities that surpass basic chatbots, e-commerce tools, and booking software",
